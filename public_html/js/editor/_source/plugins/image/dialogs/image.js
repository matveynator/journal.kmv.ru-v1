	...
	var imageDialog = function( editor, dialogType )
	{
		...
		return {
			...
			onOk : function()
			{
                ...
                this.linkElement.setAttribute('rel', 'lightbox-0');
                this.linkElement.setAttribute('class', 'lightbox-enabled');
                this.linkElement.setAttribute('title', this.imageElement.getAttribute('alt'));
									...
									[
										{
											...
											'<img id="previewImage" src="" alt="" width="200"/></a>'+
											'</div>'+'</div>'
										}
									]
								}
